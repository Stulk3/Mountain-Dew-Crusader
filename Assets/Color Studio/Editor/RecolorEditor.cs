    ...
    public class RecolorEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (rc.enabled) {
                ...
                if (GUILayout.Button("Bake & Remove ReColor...")) {
                    if (EditorUtility.DisplayDialog("Bake Color Modifications", "Are you sure you want to save the color adjustments into the material permanently?", "Bake", "Cancel")) {
                        rc.Refresh();
                        rc.Bake();
                        GUIUtility.ExitGUI();
                    }
